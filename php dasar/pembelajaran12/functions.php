...
function register($value) {
    ...
    // variable data
    // stripslashes merupakan syntax untuk menghilangkan karakter (\) pada saat menginput kan data aar tidak dapat mengganggu jalannya program
    $username = strtolower(stripslashes(htmlspecialchars(mysqli_real_escape_string($conn,$value["username"]))));
